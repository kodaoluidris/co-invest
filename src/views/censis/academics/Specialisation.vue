<template>
  <v-row>
    <!-- basic -->
    <v-col cols="12">
      <p class="text-2xl mb-10">Specialisation</p>
      <v-card>
        <v-row>
          <v-col cols="8">
              ...
              <v-card-text>
                <v-container>
                  <v-row>
                    ...
                    <v-col cols="12" sm="6" md="4">
                      <v-text-field v-model="editedItem.dept_name" label="spec_name"></v-text-field>
                    </v-col>
                    <v-col cols="12" sm="6" md="4">
                      <v-text-field v-model="editedItem.dept_code" label="prog_name"></v-text-field>
                    </v-col>
                    <v-col cols="12" sm="6" md="4">
                      <v-text-field v-model="editedItem.dept_email" label="sm" ></v-text-field>
                    </v-col>
                    <v-col cols="12" sm="6" md="4">
                      <v-text-field v-model="editedItem.hod_name" label="em"></v-text-field>
                    </v-col>
                    <v-col cols="12" sm="6" md="4">
                      <v-text-field v-model="editedItem.dept_email" label="sl" ></v-text-field>
                    </v-col>
                    <v-col cols="12" sm="6" md="4">
                      <v-text-field v-model="editedItem.hod_name" label="el"></v-text-field>
                    </v-col>
...
import data from '../../tables/datatable/spec_datatable'
...
export default {
  ...
  data: () => ({
    ...
    headers: [
      { text: 'ID', value: 'id' },
      { text: 'Specialisation', value: 'spec_name' },
      { text: 'Programme Name', value: 'prog_name' },
      { text: 'Study Mode', value: 'sm' },
      { text: 'Entry Mode', value: 'em' },
