<template>
  <v-row>
    <!-- basic -->
    <v-col cols="12">
      <p class="text-2xl mb-10">Programmes</p>
      <v-card>
        <v-row>
          <v-col cols="12" sm="6">
            <v-card-title>Programme</v-card-title>
          </v-col>
            ...
            <div class="d-flex align-center flex-wrap">
              ...
              <v-dialog v-model="isDialogVisible" persistent max-width="600px">
                <template #activator="{ on, attrs }">
                  <v-btn color="primary" dark v-bind="attrs" v-on="on"><v-icon>{{ icons.mdiPlus }}</v-icon> Add Programme </v-btn>
                </template>
                ...
                <v-card>
                    ...
                    <v-container>
                      <v-row>
                        <v-col cols="12" sm="6" md="6">
                          <v-text-field label="College Title" dense></v-text-field>
                        </v-col>
                        <v-col cols="12" sm="6" md="6">
                          <v-text-field
                            label="College Name"
                        ...
                        <v-col cols="12">
                          <v-text-field label="College Email" dense></v-text-field>
                        </v-col>
                        <v-col cols="12">
                          <v-text-field label="College Phone" dense></v-text-field>
                        </v-col>
                  ...
                  <v-card-actions>
                    ...
                    <v-btn color="success" @click="isDialogVisible = false"> Create </v-btn>
                  </v-card-actions>
                </v-card>
              </v-dialog>
            </div>
        ...
        <div>
          <v-data-table :headers="headers" :items="userList" sort-by="calories">
            <!-- action -->
                ...
                <v-container>
                  <v-row>
                    <v-col cols="12" sm="6" md="4">
                      <v-text-field v-model="editedItem.number" label="" type="number"></v-text-field>
                    </v-col>
                    <v-col cols="12" sm="6" md="4">
                      <v-text-field v-model="editedItem.prog_name" label="prog_name"></v-text-field>
                    </v-col>
                    <v-col cols="12" sm="6" md="4">
                      <v-text-field v-model="editedItem.dept_name" label="dept_name"></v-text-field>
                    </v-col>
                    <v-col cols="12" sm="6" md="4">
                      <v-text-field v-model="editedItem.sl" label="sl"></v-text-field>
                    </v-col>
                    <v-col cols="12" sm="6" md="4">
                      <v-text-field v-model="editedItem.el" label="el"></v-text-field>
                    </v-col>
...
import data from '../../tables/datatable/prog_datatable'
...
export default {
  ...
  data: () => ({
    ...
    headers: [
      { text: 'ID', value: 'id' },
      { text: 'Programme Name', value: 'prog_name' },
      { text: 'Department Name', value: 'dept_name' },
      { text: 'Start Level', value: 'sl' },
      { text: 'End Level', value: 'el' },
