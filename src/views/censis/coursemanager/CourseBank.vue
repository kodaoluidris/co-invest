<template>
  ...
  <div id="user-list">
    <!-- app drawer -->
    <user-list-add-new
      v-model="isAddNewCourseSidebarActive"
    ...
    <v-col cols="12">
      ...
      <v-card>
        <v-card-title>
          Course Bank
          <v-spacer></v-spacer>
          <v-btn color="primary" class="" @click.stop="isAddNewCourseSidebarActive = !isAddNewCourseSidebarActive">
                ...
                <v-container>
                  <v-row>
                    <v-col cols="12" sm="6" md="4">
                      <v-text-field v-model="editedItem.course_code" label="" type="course_code"></v-text-field>
                    </v-col>
                    <v-col cols="12" sm="6" md="4">
...
import data from '../../tables/datatable/coursebank_datatable'


// sidebar
import { avatarText } from '@core/utils/filter'
import UserListAddNew from '../../apps/user/user-list/addnewcourse.vue'
