<template>
  <v-row>
    <!-- basic -->
    <v-col cols="12">
      <p class="text-2xl mb-10">Course Administration</p>
      <v-card>
        <v-row>
          <v-col cols="9">
            <v-card-title>Course Bank</v-card-title>
          </v-col>

          <v-col cols="3">
            <v-col cols="12" md="12">
              <app-card-code title="Form" :code="codeSnippets.dialogForm">
                <v-card-text>Just a simple example of a form in a dialog.</v-card-text>

                <v-card-text>
                  <demo-dialog-form></demo-dialog-form>
                </v-card-text>
              </app-card-code>
            </v-col>
          </v-col>
                ...
                <v-container>
                  <v-row>
                    <v-col cols="12" sm="6" md="4">
                      <v-text-field v-model="editedItem.curriculum_name" label="curriculum_name"></v-text-field>
                    </v-col>
...
import data from '../../tables/datatable/curriculum_datatable'
...
export default {
  ...
  setup() {
    const menusVariant = ['Add Curriculum']
    const items = [{ title: 'Add Curriculum' }]
  ...
  data: () => ({
    ...
    headers: [
      { text: 'ID', value: 'id' },
      { text: 'Curriculum Name', value: 'curriculum_name' },
