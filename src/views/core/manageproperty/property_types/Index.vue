<template>
  <v-row>
                      ...
                      >
                        ...
                        <v-list>
                          ...
                          <v-list-item>
                            <v-list-item-title
                              style="cursor:pointer"
                              @click="pass_current(p); $bvModal.show('edit_property_type')"
                            >
                            ...
                            >
                              ...
                              >
                                ...
                                <v-card>
                                  ...
                                  >
                                    Change Property type status to inactive ?
                                  </v-card-title>
                              ...
                              >
                                ...
                                <v-card>
                                  <v-card-title
                                    ...
                                    style="font-size:1.1rem !important"
                                  >
                                    Change Property type status to active ?
                                  </v-card-title>
                                  <v-card-text>Are you sure you want to perform this operation.</v-card-text>
                                  <v-card-actions>
                                    <v-spacer></v-spacer>
    ...
    <b-modal
      ...
      hide-footer
      :title="'Edit Property type ' + current.name"
    >
      <edit
        :my_modal="$bvModal"
        :data="current"
